...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "ox3BU2hOITf1slag74TOYtVeguJHDjGp"
                               }
# 7. Provide the URL to the MapQuest GeoCode API.
        r = requests.get("https://www.mapquestapi.com/geocoding/v1/address?key=ox3BU2hOITf1slag74TOYtVeguJHDjGp&location=Sudbury,ON", 
